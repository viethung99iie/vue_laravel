            ...
            const renderData = async (page, query) => {
                try {
                    ...
                    tableData.value.forEach(item => {
                        switchState[item.id] = item.publish === 2;
                    })
            ...
            const getRowStatus = (id) => {
                return switchItems.value[id] || false;
            }
            onMounted(() => {
                renderData();
                emitSearch();
            ...
            <template>
                        ...
                        <template v-if="tableData.length > 0">
                            <tr v-for="(val, key) in tableData" :key="key"
                                ...
                                <td class="uk-flex-center text-center uk-flex">
                                    ...
                                    <template
                                        v-if="tableConfig.action.length > 0">
                                        <RouterLink
                ...
                <div class="paginate"
                    ...
                    <ul class="uk-pagination uk-flex-center" uk-margin>
                        ...
                        <li v-for="(val, index) in pagination.links"
                            :key="index" :class="{ 'uk-active': val.active }"
